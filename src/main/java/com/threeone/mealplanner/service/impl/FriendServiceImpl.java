...
public class FriendServiceImpl implements FriendService {
	...
	public UserInfoWithFriends getFriendRequestsByStatus(int friendId, int status) throws InternalException {
		try {
			...
			List<UserInfoForShow> userInfos = new ArrayList<UserInfoForShow>();
			...
			for (Integer id : ids) {
				UserInfoForShow userInfo = userInfoMapper.getUserInfoForShow(id);
	...
	public UserInfoWithFriends getAllFriendInfos(int userId) throws InternalException {
		try {
			...
			for (Integer id : friendIds) {
				UserInfoForShow userInfo = new UserInfoForShow();
				userInfo = userInfoMapper.getUserInfoForShow(id);
				userInfos.add(userInfo);
			}
			userInfoWithFriends.setUserInfos(userInfos);
